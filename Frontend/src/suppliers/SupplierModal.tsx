...
const SupplierModal: React.FC<SupplierModalProps> = ({
  ...
  const validateForm = () => {
    ...
    if (formData.averageLeadTimeDays < 1) {
      newErrors.averageLeadTimeDays = 'Lead time must be at least 1 day';
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('averageLeadTimeDays', parseInt(e.target.value) || 1)}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                    errors.averageLeadTimeDays ? 'border-red-300' : 'border-gray-300'
                  }`}
                />
                {errors.averageLeadTimeDays && (
                  <p className="text-sm text-red-600 mt-1">{errors.averageLeadTimeDays}</p>
                )}
              </div>
