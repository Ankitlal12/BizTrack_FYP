...
const WebsiteHome = () => {
  ...
  return (
    <div className="biz-home min-h-screen overflow-x-hidden">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        <section className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-[#c6ddd3] bg-[#f8fcfa] p-4 shadow-[0_20px_50px_rgba(13,70,54,0.15)]">
              <div className="biz-grid-overlay" />
              <div className="rounded-2xl border border-[#d6e7df] bg-white p-4">
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    <p className="text-xs uppercase tracking-[0.12em] text-[#5c7f72]">Today</p>
                    <p className="text-xl font-bold text-[#122b24]">Rs 42,580 Revenue</p>
                  </div>
                  <div className="rounded-lg bg-[#eaf7f1] p-2 text-[#0e7a5f]">
                    <LineChart size={18} />
                  </div>
                </div>
              ...
              <div className="pointer-events-none absolute -right-4 top-8 biz-float">
                <div className="rounded-xl border border-[#bfd8cc] bg-white/95 px-3 py-2 text-xs font-semibold text-[#1f4f41] shadow-lg">
                  +18% Monthly Sales Growth
                </div>
              </div>

              <div className="pointer-events-none absolute -left-3 bottom-8 biz-float-delayed">
                <div className="rounded-xl border border-[#bfd8cc] bg-white/95 px-3 py-2 text-xs font-semibold text-[#1f4f41] shadow-lg">
        ...
        <section className="mt-10 grid gap-3 rounded-2xl border border-[#d4e5de] bg-white p-4 sm:grid-cols-3 sm:p-5">
        ...
        <section className="mt-12 rounded-3xl border border-[#d4e5de] bg-[#f8fbfa] p-6 sm:p-8">
        ...
        <section className="mt-12 grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-[#d3e5de] bg-white p-6 sm:p-7 shadow-sm">
            <p className="text-xs uppercase tracking-[0.12em] text-[#5f7e73]">How It Works</p>
            <h3 className="biz-heading mt-2 text-2xl text-[#15342c]">Go live in 3 clean steps</h3>
            <ol className="mt-5 space-y-4 text-sm text-[#3b5f53]">
              <li className="flex gap-3"><span className="mt-0.5 grid h-6 w-6 place-items-center rounded-full bg-[#e7f4ee] font-bold text-[#0f6c55]">1</span>Create your owner workspace and invite team members.</li>
              <li className="flex gap-3"><span className="mt-0.5 grid h-6 w-6 place-items-center rounded-full bg-[#e7f4ee] font-bold text-[#0f6c55]">2</span>Add products, suppliers, and customer data once.</li>
              <li className="flex gap-3"><span className="mt-0.5 grid h-6 w-6 place-items-center rounded-full bg-[#e7f4ee] font-bold text-[#0f6c55]">3</span>Run daily billing, purchasing, and insights from one dashboard.</li>
            </ol>
          </div>

          <div className="rounded-3xl border border-[#174b3d] bg-[#123d32] p-6 text-white sm:p-7 shadow-[0_16px_35px_rgba(9,56,43,0.3)]">
            <p className="text-xs uppercase tracking-[0.12em] text-[#b7d8cc]">Simple Pricing</p>
            <h3 className="biz-heading mt-2 text-3xl text-white">One plan. No confusion.</h3>
            <p className="mt-3 text-sm text-[#d6e9e1]">Full retail operations stack in one predictable monthly plan.</p>

            <div className="mt-6 rounded-2xl bg-[#0f332a] p-4">
              <p className="text-sm text-[#bee1d5]">BizTrack Business</p>
              <p className="mt-1 text-4xl font-black">NPR 999</p>
              <p className="text-xs text-[#b9d8ce]">Per month, per workspace</p>
              <ul className="mt-4 space-y-2 text-sm text-[#deefe9]">
                <li>Private owner workspace</li>
                <li>Unlimited daily billing and operations</li>
                <li>Manager and staff role access</li>
                <li>Billing, inventory, purchases, and reports</li>
              </ul>
            </div>

            <Link
              to="/signup"
              className="mt-5 inline-flex items-center gap-2 rounded-xl bg-[#f3cc7f] px-5 py-3 text-sm font-bold text-[#143228] transition hover:bg-[#ebc06a]"
            >
        ...
        <section className="mt-12 grid gap-4 lg:grid-cols-2">
          {testimonials.map((testimonial) => (
            <div key={testimonial.name} className="rounded-2xl border border-[#d9e7e2] bg-white p-5 shadow-sm transition hover:-translate-y-[2px] hover:shadow-md">
              ...
              <p className="text-sm leading-7 text-[#31584b]">“{testimonial.quote}”</p>
        ...
        <section className="mt-12 rounded-3xl border border-[#d6e6df] bg-white p-6 sm:p-7">
          <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
              <p className="text-xs uppercase tracking-[0.12em] text-[#5f8174]">Final Call</p>
              <h3 className="biz-heading mt-2 text-3xl text-[#15322a]">Ready to scale with confidence?</h3>
              <p className="mt-3 text-sm text-[#47675c]">Launch a modern workspace your team adopts quickly and your customers feel in every fast, smooth checkout.</p>

              <div className="mt-4 flex flex-wrap items-center gap-2 text-xs font-semibold text-[#315c4f]">
                <span className="inline-flex items-center gap-1 rounded-full bg-[#edf7f2] px-3 py-1"><Building2 size={13} /> Owner Ready</span>
                <span className="inline-flex items-center gap-1 rounded-full bg-[#edf7f2] px-3 py-1"><Globe size={13} /> Multi-location ready</span>
                <span className="inline-flex items-center gap-1 rounded-full bg-[#edf7f2] px-3 py-1"><MessageCircleHeart size={13} /> Team-loved UX</span>
              </div>
            </div>

            <div className="flex flex-wrap gap-3 lg:justify-end">
              <Link to="/signup" className="rounded-xl bg-[#0e7a5f] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#0b624c]">Create Workspace</Link>
              <Link to="/login" className="rounded-xl border border-[#bbd0c7] px-5 py-3 text-sm font-bold text-[#25453a] transition hover:bg-[#f1f7f4]">Open Login</Link>
            </div>
          </div>
        </section>
      </main>
...
const StatCard = ({ label, value }: { label: string; value: string }) => (
  <div className="rounded-xl border border-[#dceae4] bg-[#fbfefd] p-3">
    <p className="text-xs text-[#5c7f72]">{label}</p>
    <p className="mt-1 text-base font-bold text-[#163228]">{value}</p>
  </div>
)

const MiniPill = ({ icon, text }: { icon: React.ReactNode; text: string }) => (
  <div className="inline-flex items-center gap-2 rounded-xl border border-[#d3e4dc] bg-white px-3 py-2 text-xs font-semibold text-[#355f52]">
    <span className="text-[#0e7a5f]">{icon}</span>
    <span>{text}</span>
  </div>
)

const Feature = ({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) => (
  <div className="reveal-card rounded-2xl border border-[#d7e8e2] bg-white p-4 shadow-sm transition hover:-translate-y-[2px] hover:shadow-md">
...
const MetricCard = ({ icon, label, value }: { icon: React.ReactNode; label: string; value: string }) => (
  <div className="rounded-xl border border-[#d9e8e2] bg-[#f8fcfa] p-4 transition hover:bg-white hover:shadow-sm">
    <div className="mb-2 inline-flex rounded-lg bg-[#eaf6f1] p-2 text-[#0e7a5f]">{icon}</div>
    <p className="text-xs text-[#5f7e73]">{label}</p>
    <p className="mt-1 text-xl font-extrabold text-[#153a2f]">{value}</p>
  </div>
)
